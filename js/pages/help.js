...
const questions = [
  ...
  ["How do I change the map theme?", "Open Settings and find Map preferences. Choose Light, Dark, or Follow system. The map theme is used when you open the location picker on the trip page."],
  ["How do I clear offline data?", "Open Settings and find Offline data. Choose Clear offline data to remove cached trip coordinates, pending trip data, geocoded address lookups, and report caches from this device. Your account data in the cloud is not affected."],
  ...
  ["How do trip reports work?", "Trip reports summarize recorded journeys, including vehicle, date, trip type, purpose, origin, destination, odometer readings, and distance. Use the filters to review a specific vehicle or period, or choose the tax-year button to select the current SARS tax year (1 March to end of February). The report shows total distance, the business/personal split, and the business-use percentage."],
  ["How do I export a SARS-compliant logbook?", "Open Trip report, set the period (or use the tax-year button), then choose SARS PDF. A print-ready document opens containing all SARS-required fields — trip date, opening and closing odometer readings, distance, destination, and business reason — plus annual odometer readings per vehicle, the business/personal split, and a five-year retention declaration. Trips flagged as anomalies by the analytics engine are highlighted in both the PDF and the CSV export."],
  ["What does the Analytics page show?", "The Analytics page analyzes your trip, fuel, and service data entirely on your device. It flags trips with distances outside 20% of your average, highlights fill-ups with abnormal fuel consumption compared to your last 5 fill-ups, and detects overdue services. It also predicts your next service date, estimates monthly fuel costs, and projects your business vs personal mileage split for the current tax year. Charts include a fuel-efficiency trend line, a business vs personal bar chart, and a service compliance gauge. Results are cached so the page works offline."],
